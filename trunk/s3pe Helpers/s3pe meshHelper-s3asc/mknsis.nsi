...
!define PROGRAM_NAME "s3pe meshHelper for MilkShape"
...
gotAll:  
  ...
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\${INSTREGKEY}" "HelpLink" "http://www.den.simlogical.com/denforum/index.php?topic=807.0"
