...
namespace AutoUpdate
{
    ...
    {
        static PackageCompareUtility.Properties.Settings pgmSettings = PackageCompareUtility.Properties.Settings.Default;
        ...
        public static bool GetUpdate(bool autoCheck)
        {
            ...
            try
            {
                ...
                try
                {
                    using (PackageCompareUtility.Splash splash = new PackageCompareUtility.Splash("Checking for updates..."))
                    {
                        splash.Show();
